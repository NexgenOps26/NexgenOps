    ...
    <aside className="relative order-2 min-h-[760px] overflow-hidden bg-[radial-gradient(circle_at_12%_10%,rgba(37,99,235,0.28),transparent_24%),radial-gradient(circle_at_88%_86%,rgba(59,130,246,0.2),transparent_25%),linear-gradient(135deg,#020617_0%,#04122c_48%,#061b45_100%)] px-6 py-8 text-white sm:px-10 lg:order-1 lg:flex lg:h-full lg:min-h-0 lg:basis-[52%] lg:px-10 lg:py-6 xl:px-14">
      ...
      <div className="relative z-10 flex w-full flex-col lg:justify-between">
        <header>
          <Logo
            showWordmark
            imageClassName="h-20 w-20 sm:h-24 sm:w-24 lg:h-16 lg:w-16"
          />
          <p className="mt-6 max-w-full text-sm font-medium uppercase tracking-[0.25em] text-slate-300 sm:text-base lg:mt-3 lg:text-xs xl:text-sm">
        ...
        <main className="flex flex-1 flex-col justify-center py-12 lg:min-h-0 lg:py-4 xl:py-5">
          ...
          <p className="mt-6 max-w-[580px] text-lg leading-8 text-slate-300 sm:text-xl sm:leading-9 lg:mt-3 lg:text-sm lg:leading-6 xl:text-base xl:leading-7 2xl:text-lg 2xl:leading-8">
          ...
          <div className="mt-10 lg:mt-5 xl:mt-6 2xl:mt-9">
            <FeatureGrid />
          </div>
        </main>

        <footer className="border-t border-white/10 pt-5 text-sm text-slate-400 sm:flex sm:items-center sm:justify-between lg:pt-4 lg:text-xs xl:text-sm">
